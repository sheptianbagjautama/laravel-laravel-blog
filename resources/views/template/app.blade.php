    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="{{ url('index') }}"><i class="fa fa-link"></i> <span>Dashboard</span></a></li>


                @if(Auth::user()->role == 'admin')
                    {{-- show menu if role login as admin--}}

                    <li class="active"><a href="{{ route('admin.settings.index') }}"><i class="fa fa-link"></i> <span>Settings</span></a></li>
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    {{-- MENU COMMENTS --}}
                    <li class="active"><a href="{{ route('admin.comments.index') }}"><i class="fa fa-link"></i> <span>Comments</span></a></li>
