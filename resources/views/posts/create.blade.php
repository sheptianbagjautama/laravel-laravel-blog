        ...
        <form role="form" method="post" action="{{ route('admin.posts.store')  }}" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="title" value="{{ old('title') }}" id="name" class="form-control" id="exampleInputEmail1" placeholder="Enter title" required>
                </div>
                ...
                <div class="form-group">
                    <label>Image</label>
                    <input type="file" name="featured"  id="featured" class="form-control" id="exampleInputEmail1" required>
                </div>
